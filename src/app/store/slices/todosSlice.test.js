...
import todosReducer, { addTodo, toggleTodo, deleteTodo, setFilter, clearCompleted, selectTodos, selectFilter, selectFilteredTodos, selectItemsLeft, } from './todosSlice';
describe('todosSlice', () => {
    ...
    describe('selectors', () => {
        ...
        test('selectFilteredTodos filters correctly', () => {
            ...
            // Active filter
            const activeState = { ...mockState, todos: { ...mockState.todos, filter: 'active' } };
            result = selectFilteredTodos(activeState);
            expect(result).toHaveLength(2);
            // Completed filter
            const completedState = { ...mockState, todos: { ...mockState.todos, filter: 'completed' } };
